...
class AutocompleteTokenField extends Component {
	...
	render() {
		...
		const classNames = [ 'tawfeer-autocomplete-tokenfield__input-container' ];
		...
		return (
			<div className="tawfeer-autocomplete-tokenfield">
				...
				{ help && <p className="tawfeer-autocomplete-tokenfield__help">{ help }</p> }
			</div>
		);
	}
}
