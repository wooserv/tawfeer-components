...
const PORTAL_PARENT_ID = 'tawfeer-components-web-preview-wrapper';
...
class WebPreview extends Component {
	...
	getWebPreviewModal = () => {
		...
		const classes = classnames( 'tawfeer-web-preview', device, loaded && 'is-loaded' );
		beforeLoad();
		return createPortal(
			<div className={ classes }>
				<div className="tawfeer-web-preview__interior">
					<div className="tawfeer-web-preview__toolbar">
						<div className="tawfeer-web-preview__toolbar-left">
							<ButtonGroup>
								<Button
						...
						<div className="tawfeer-web-preview__toolbar-right">
							<Button
								onClick={ () => {
									onClose();
					...
					<div className="tawfeer-web-preview__content">
						{ ! loaded && (
							<div className="tawfeer-web-preview__is-waiting">
								<Waiting isLeft />
